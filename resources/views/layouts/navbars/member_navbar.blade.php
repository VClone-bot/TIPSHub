<!-- BARRE DE NAVIGATION RÉSERVÉE AUX MEMBRES -->
...
<nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark" style="background-color:#1b1b1b;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <!-- Gazette Navlink Item -->
            <li class="nav-item">
                <a class="nav-link" href="gazette"><i class="fa fa-commenting-o"></i> La Gazette</a>
            </li>
            <!-- Member Infos Navlink Item -->
            <li class="nav-item">
                <a class="nav-link" href="member_infos"><i class="fa fa-exclamation-circle"></i> Infos membres</a>
            </li>
