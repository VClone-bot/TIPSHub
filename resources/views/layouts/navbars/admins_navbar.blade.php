<!-- BARRE DE NAVIGATION RÉSERVÉE AUX ADMINS -->

@if(Session::get('LoggedUser') && Session::get('IS_ADMIN')) 
...
<nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark" style="background-color:#1b1b1b;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <!-- Administration Navlink Item -->
            <li class="nav-item">
                <a class="nav-link" href="administration"><i class="fa fa-terminal"></i> Administration</a>
            </li>
